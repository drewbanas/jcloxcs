...
namespace jlox
{
    ...
    class Interpreter : Expr.Visitor<object>, Stmt.Visitor<object> // <Void> in jlox
    {
        ...
        /* originally with lox's main */
        private static Interpreter interpreter = null;// new Interpreter();
        static bool hadError = false;

        //unused static bool hadRuntimeError = false;
        /* originally with lox's main */
        ...
        public static InterpretResult interpret(List<Stmt> statements)
        {
#if DEBUG
            System.Console.WriteLine("jlox interpreter:\n\n");
#endif
            ...
            if (hadError)
                return InterpretResult.INTERPRET_RESOLVE_ERROR;
            /* originally with lox's main */
        ...
        public object visitLogicalExpr(Expr.Logical expr)
        {
            ...
            if (expr.operator_.type == TokenType.TOKEN_OR)
            {
                if (isTruthy(left))
                    return left;
            }
