...
namespace clox
{
    ...
    static class VM
    {
        ...
        public static void freeVM()
        {
            ...
            util.cHeap.objects.free();
            util.cHeap.values.free();
        }
        ...
        private static bool call(ObjClosure closure, int argCount)
        {
            ...
            {
                runtimeError("Expected {0} arguments but got {1}.", closure.function.arity.ToString(), argCount.ToString());
                return false;
            }
        ...
        {
#if DEBUG
            System.Console.WriteLine("clox bytecode vm:\n\n");
#endif
