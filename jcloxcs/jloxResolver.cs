...
namespace jlox
{
    ...
    class Resolver : Expr.Visitor<object>, Stmt.Visitor<object>
    {
        ...
        private FunctionType currentFunction = FunctionType.TYPE_NONE;
        ...
        public object visitSuperExpr(Expr.Super expr)
        {
            ...
            {
                Interpreter.error(expr.keyword, "Cannot use 'super' outside of a class.");
            }
            else if (currentClass != ClassType.SUBCLASS)
            {
                Interpreter.error(expr.keyword, "Cannot use 'super' in a class with no superclass.");
            }
        ...
        private void declare(Token name)
        {
            ...
            {
                // jlox doesn't enclose this in an else
                scope.Add(name.lexeme(), false); // scope.put(name.lexeme, false);
            }
        }
